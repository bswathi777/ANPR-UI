  ...
  { path: "face-recognition-video", component: FaceRecognitionVideoComponent },
  {
    ...
    children: [
      ...
      },
      {
        ...
        data: { breadcrumb: "Tracking Vehicle" },
      },
      {
        path: "email-distribution",
        component: EmailDistributionComponent,
        data: { breadcrumb: "Email Distribution" },
      },
      //{ path: 'Live Tracking', component: }
      {
        path: "covid19",
        loadChildren: () =>
          import("./pages/covid/covid.module").then((m) => m.CovidModule),
        data: { breadcrumb: "Covid-19 Updates" },
      },
